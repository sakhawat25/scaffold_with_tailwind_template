...
function layout_change(layout) {
  ...
  var logoSrc = isDark ? '../admin_assets/images/logo-white.svg' : '../admin_assets/images/logo-dark.svg';
...
function layout_theme_sidebar_change(value) {
  if (value == 'true') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../admin_assets/images/logo-dark.svg');
    }
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../admin_assets/images/logo-white.svg');
    }
    var control = document.querySelector('.theme-nav-layout .btn.active');
    if (control) {
      document.querySelector('.theme-nav-layout .btn.active').classList.remove('active');
