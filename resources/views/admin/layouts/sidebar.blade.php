    ...
    <div class="navbar-wrapper">
        <div class="m-header flex items-center py-4 px-6 h-header-height">
            <a href="../dashboard/index.html" class="b-brand flex items-center gap-3">
                ...
                <img src="{{ asset('admin_assets/images/logo-white.svg') }}" class="img-fluid logo logo-lg"
                    alt="logo" />
                <img src="{{ asset('admin_assets/images/favicon.svg') }}" class="img-fluid logo logo-sm" alt="logo" />
            </a>
        </div>
        <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="{{ route('admin.typography') }}" class="pc-link">
                        <span class="pc-micon"> <i data-feather="type"></i></span>
                        <span class="pc-mtext">Typography</span>
                    </a>
                </li>
                <li class="pc-item pc-hasmenu">
                    <a href="{{ route('admin.icons') }}" class="pc-link">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="{{ route('admin.loginv1') }}" class="pc-link" target="_blank">
                        <span class="pc-micon"> <i data-feather="lock"></i></span>
                        <span class="pc-mtext">Login</span>
                    </a>
                </li>
                <li class="pc-item pc-hasmenu">
                    <a href="{{ route('admin.registerv1') }}" class="pc-link" target="_blank">
