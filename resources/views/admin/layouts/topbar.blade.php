                                    ...
                                    <div class="flex gap-4">
                                        <div class="shrink-0">
                                            <img class="img-radius w-12 h-12 rounded-0"
                                                src="{{ asset('admin_assets/images/user/avatar-1.jpg') }}"
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div class="shrink-0">
                                            <img class="img-radius w-12 h-12 rounded-0"
                                                src="{{ asset('admin_assets/images/user/avatar-2.jpg') }}"
                                                alt="Generic placeholder image" />
                                        </div>
                                        <div class="grow">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div class="shrink-0">
                                            <img class="img-radius w-12 h-12 rounded-0"
                                                src="{{ asset('admin_assets/images/user/avatar-3.jpg') }}"
                                                alt="Generic placeholder image" />
                                        </div>
                                        <div class="grow ms-3">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div class="shrink-0">
                                            <img class="img-radius w-12 h-12 rounded-0"
                                                src="{{ asset('admin_assets/images/user/avatar-4.jpg') }}"
                                                alt="Generic placeholder image" />
                                        </div>
                                        <div class="grow ms-3">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="flex gap-4">
                                        <div class="shrink-0">
                                            <img class="img-radius w-12 h-12 rounded-0"
                                                src="{{ asset('admin_assets/images/user/avatar-5.jpg') }}"
                                                alt="Generic placeholder image" />
                                        </div>
                                        <div class="grow ms-3">
