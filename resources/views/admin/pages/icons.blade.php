            ...
            <div class="col-span-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>
                            Use svg icon with
                            <code class="text-danger-400 text-sm">&lt;i
                                data-feather="&lt;&lt; Copied code &gt;&gt;"&gt;</code>
                            in you html code
                        </p>
                    </div>
                    <div class="card-body text-center">
                        ...
                        <div class="i-main text-center *:relative *:cursor-pointer *:inline-flex *:items-center *:justify-center *:w-[70px] *:h-[70px] *:m-[5px] *:rounded-lg *:border *:border-theme-border dark:*:border-themedark-border"
                            id="icon-wrapper"></div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script src="{{ asset('admin_assets/js/plugins/clipboard.min.js') }}"></script>
    <script>
        var icon_list = [
            'alert-octagon',
            'alert-circle',
        ...
        window.addEventListener('load', (event) => {
            ...
            i_copy.on('success', function(e) {
                ...
                icon_badge.setAttribute('class',
                    'ic-badge badge bg-success-500 text-white text-sm absolute bottom-1 left-2/4 -translate-x-2/4'
                    );
            ...
            i_copy.on('error', function(e) {
                ...
                let icon_badge = document.createElement('span');
                icon_badge.setAttribute('class',
                    'ic-badge badge bg-danger-500 text-white text-sm absolute bottom-1 left-2/4 -translate-x-2/4'
                    );
