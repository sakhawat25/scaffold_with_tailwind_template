            ...
            <div class="col-span-12 md:col-span-6">
                <div class="card">
                    ...
                    <div class="card-body pc-component">
                        ...
                        <p class="text-success-500 mb-1">Duis mollis, est non commodo luctus, nisi erat porttitor ligula.
                        </p>
                        ...
                        <p class="text-dark-500 dark:text-white mb-1">Nullam id dolor id nibh ultricies vehicula ut id elit.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pc-component">
                        ...
                        <blockquote class="py-2 px-4 text-[1rem]">
                            <p class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat
                                a ante.
                            </p>
                            <footer
